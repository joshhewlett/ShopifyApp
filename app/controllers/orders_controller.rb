class OrdersController < ApplicationController
  ...
  def import
      ...
      respond_to do |format|
        ...
        notice: "#{result[:created].to_i} created, #{result[:failed]} failed"}
    end
  end
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:number, :email, :first_name, :last_name, :shopify_order_id, :order_date, :total_float, :line_item_count, :financial_status)
    end
end
